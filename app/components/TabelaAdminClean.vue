<template>
  <div class="bg-white rounded shadow p-4">
    ...
    <BaseModal :show="showModal" @cancel="handleCancel" @confirm="handleConfirm">
      <h3 slot="header" class="text-lg font-semibold">Novo Usuário</h3>
      ...
      <div slot="footer">
        <BaseButton @click="handleCancel" variant="secondary">Cancelar</BaseButton>
        <BaseButton @click="handleConfirm" variant="primary">Criar conta</BaseButton>
      </div>
    </BaseModal>
  </div>
</template>
